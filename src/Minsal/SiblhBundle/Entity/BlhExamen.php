 ...
 * BlhExamen
 *
 * @ORM\Table(name="blh_examen", indexes={@ORM\Index(name="IDX_BAD2C294D8A5832B", columns={"id_user_reg"})})
 * @ORM\Entity
 */
class BlhExamen implements EntityInterface
{
    /**
     * @var integer
     *
    ...
    {
        return (string) $this->nombreExamen;
    }
