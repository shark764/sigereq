 ...
 * BlhRol
 *
 * @ORM\Table(name="blh_rol", indexes={@ORM\Index(name="IDX_354B88CED8A5832B", columns={"id_user_reg"})})
 * @ORM\Entity
 */
class BlhRol implements EntityInterface
{
    /**
     * @var integer
     *
