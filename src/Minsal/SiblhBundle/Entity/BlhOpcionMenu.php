 ...
 * BlhOpcionMenu
 *
 * @ORM\Table(name="blh_opcion_menu", indexes={@ORM\Index(name="fk_menu_opcion_menu", columns={"id_menu"}), @ORM\Index(name="IDX_B7712BFBD8A5832B", columns={"id_user_reg"})})
 * @ORM\Entity
 */
class BlhOpcionMenu implements EntityInterface
{
    ...
    {
        return (string) $this->nombreOpcion;
    }
