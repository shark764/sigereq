...
use Minsal\SiblhBundle\Generator\ListViewGenerator\TableGenerator\BlhEntityListViewGenerator;
 ...
 * @author farid
 */
class MntExpedienteListViewGenerator extends BlhEntityListViewGenerator
{
    /**
     * Sets the array.
     *
