...
use Minsal\SiblhBundle\Generator\ListViewGenerator\TableGenerator\BlhFrascoRecolectadoListViewGenerator;

class BlhAnalisisSensorialAdminController extends MinsalSiblhBundleGeneralAdminController
{
    /**
