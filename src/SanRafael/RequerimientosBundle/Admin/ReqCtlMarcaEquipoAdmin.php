...
class ReqCtlMarcaEquipoAdmin extends SanRafaelRequerimientosAdmin
{
    protected $baseRouteName    = 'sigereq_marca_equipo';
    protected $baseRoutePattern = 'catalogo/marca-equipo';
    ...
    public function getNewInstance()
    {
         ...
         * default values
         */
        $instance->setIdMarcaGrupo($this->getModelManager()->findOneBy('SanRafaelRequerimientosBundle:ReqCtlMarcaEquipo', array('codigo' => 'DLL')));
