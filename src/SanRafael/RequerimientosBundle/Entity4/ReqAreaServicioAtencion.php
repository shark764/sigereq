...
class ReqAreaServicioAtencion
{
	...
	{
	    return $this->nombre ? strtoupper(trim($this->codigo)) . ' - ' . mb_strtoupper(trim($this->nombre), 'utf-8') . ' | ' . strtoupper(trim($this->idServicioExterno)) . ' | ' . strtoupper(trim($this->idModalidadAtencion)) : '';
	}
        return $this->nombre ? strtoupper(trim($this->codigo)) . ' - ' . mb_strtoupper(trim($this->nombre), 'utf-8') . ' | ' . strtoupper(trim($this->idModalidadAtencion)) : '';
    }
