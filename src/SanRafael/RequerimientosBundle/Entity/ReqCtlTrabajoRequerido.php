 ...
 *
 * @ORM\Table(name="req_ctl_trabajo_requerido", uniqueConstraints={@ORM\UniqueConstraint(name="idx_req_codigo_trabajo_requerido", columns={"codigo"})}, indexes={@ORM\Index(name="IDX_577A5776E361769B", columns={"id_trabajo_requerido_padre"}), @ORM\Index(name="IDX_577A5776DDC7A485", columns={"id_area_trabajo"})})
