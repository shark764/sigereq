...
--
-- Name: blh_ctl_acidez_dornic; Type: TABLE; Schema: public; Owner: siblh; Tablespace: 
--

CREATE TABLE blh_ctl_acidez_dornic (
...
ALTER TABLE blh_ctl_acidez_dornic OWNER TO siblh;

--
-- Name: blh_ctl_acidez_dornic_id_seq; Type: SEQUENCE; Schema: public; Owner: siblh
--

CREATE SEQUENCE blh_ctl_acidez_dornic_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE blh_ctl_acidez_dornic_id_seq OWNER TO siblh;

--
-- Name: blh_ctl_acidez_dornic_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: siblh
--

ALTER SEQUENCE blh_ctl_acidez_dornic_id_seq OWNED BY blh_ctl_acidez_dornic.id;


--
-- Name: blh_ctl_caloria; Type: TABLE; Schema: public; Owner: siblh; Tablespace: 
--

CREATE TABLE blh_ctl_caloria (
    id smallint NOT NULL,
    nombre character varying(50) NOT NULL,
    codigo character(3),
    rango character(10)
...
ALTER TABLE blh_ctl_caloria OWNER TO siblh;

--
-- Name: blh_ctl_caloria_id_seq; Type: SEQUENCE; Schema: public; Owner: siblh
--

CREATE SEQUENCE blh_ctl_caloria_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE blh_ctl_caloria_id_seq OWNER TO siblh;

--
-- Name: blh_ctl_caloria_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: siblh
--

ALTER SEQUENCE blh_ctl_caloria_id_seq OWNED BY blh_ctl_caloria.id;
...
CREATE TABLE blh_historia_actual (
    ...
    fecha_hora_reg timestamp without time zone,
    id_user_reg integer,
    donante_apta boolean DEFAULT false,
    id_banco_de_leche integer,
    id_centro_recoleccion integer
);
...
CREATE TABLE blh_historial_clinico (
    ...
    fecha_hora_reg timestamp without time zone,
    id_user_reg integer,
    control_prenatal_embarazo boolean DEFAULT false,
    id_patologia_embarazo integer,
    id_banco_de_leche integer,
    id_centro_recoleccion integer
);
...
CREATE TABLE blh_solicitud (
    ...
    fecha_hora_reg timestamp without time zone,
    id_user_reg integer,
    id_responsable_solicitud integer,
    id_acidez_necesaria smallint,
    id_calorias_necesarias smallint,
    id_banco_de_leche integer
);
...
ALTER TABLE ONLY blh_ctl_acidez_dornic ALTER COLUMN id SET DEFAULT nextval('blh_ctl_acidez_dornic_id_seq'::regclass);
...
ALTER TABLE ONLY blh_ctl_caloria ALTER COLUMN id SET DEFAULT nextval('blh_ctl_caloria_id_seq'::regclass);
...
19	2017-07-10	DATA BASE	blh_curva	siblh	I	INSERT(3,5.00,5.00,7.00,5.70,2017-07-10,13,23.0000,00:23:54,,299,"2017-07-10 00:23:54",1)	\N	\N
20	2017-07-10	DATA BASE	blh_curva	siblh	I	INSERT(3,5.00,5.00,7.00,5.70,2017-07-10,13,23.0000,00:23:54,,299,"2017-07-10 00:23:54",1)	\N	\N
21	2017-07-10	DATA BASE	blh_curva	siblh	I	INSERT(3,5.00,5.00,7.00,5.70,2017-07-10,13,23.0000,00:23:54,,299,"2017-07-10 00:23:54",1)	\N	\N
\.
...
--
-- Data for Name: blh_ctl_acidez_dornic; Type: TABLE DATA; Schema: public; Owner: siblh
--

COPY blh_ctl_acidez_dornic (id, nombre, codigo, grados) FROM stdin;
1	Baja	BJA	0 - 4 grados   
2	Aceptable	ACT	4 - 8 grados   
\.


--
-- Name: blh_ctl_acidez_dornic_id_seq; Type: SEQUENCE SET; Schema: public; Owner: siblh
--

SELECT pg_catalog.setval('blh_ctl_acidez_dornic_id_seq', 4, true);


--
-- Data for Name: blh_ctl_caloria; Type: TABLE DATA; Schema: public; Owner: siblh
--

COPY blh_ctl_caloria (id, nombre, codigo, rango) FROM stdin;
1	Hipocalórica	HPC	< 500     
2	Normocalórica	NMC	500 - 700 
3	Hipercalórica	HPR	> 700     
\.


--
-- Name: blh_ctl_caloria_id_seq; Type: SEQUENCE SET; Schema: public; Owner: siblh
--

SELECT pg_catalog.setval('blh_ctl_caloria_id_seq', 9, true);
...
COPY blh_ctl_escolaridad (id, nombre, codigo, rango) FROM stdin;
1	Educación primaria	EPR	1ro - 6to grado
3	Educación secundaria	BCH	Bachillerato
2	Educación media	ESC	7mo - 9no grado
4	Educación superior	ESU	Estudios universitarios
5	Sin escolaridad	SED	\N
\.
...
SELECT pg_catalog.setval('blh_ctl_escolaridad_id_seq', 5, true);
...
SELECT pg_catalog.setval('blh_ctl_forma_extraccion_id_seq', 2, true);
...
1	Visita domiciliar	VSD
2	Banco de Leche Humana	BLH
3	Campaña de salud	CSL
4	Centro de Recolección	CRC
7	Otros	OTR
6	Organización no Gubernamental (ONG)	ONG
5	Puesto de Colecta en Empresa Privada	EMP
\.
...
SELECT pg_catalog.setval('blh_ctl_tipo_colecta_id_seq', 7, true);
...
3	5.00	5.00	7.00	5.70	2017-07-10	13	23.0000	00:23:54	\N	299	2017-07-10 00:23:54	1
\.
...
SELECT pg_catalog.setval('blh_curva_id_seq', 3, true);
...
COPY blh_historia_actual (id, peso_donante, talla_donante, medicamento, habito_toxico, motivo_donacion, patologia, imc, estado_donante, usuario, id_donante, fecha_hora_reg, id_user_reg, donante_apta, id_banco_de_leche, id_centro_recoleccion) FROM stdin;
\.
...
COPY blh_historial_clinico (id, control_prenatal, edad_gest_fur, lugar_control, numero_control, fecha_parto, lugar_parto, patologia_embarazo, periodo_intergenesico, fecha_parto_anterior, formula_obstetrica_g, formula_obstetrica_p1, formula_obstetrica_p2, formula_obstetrica_a, formula_obstetrica_v, formula_obstetrica_m, usuario, id_donante, id_establecimiento, fecha_hora_reg, id_user_reg, control_prenatal_embarazo, id_patologia_embarazo, id_banco_de_leche, id_centro_recoleccion) FROM stdin;
\.
...
COPY blh_pasteurizacion (id, id_curva, codigo_pasteurizacion, num_ciclo, volumen_pasteurizado, num_frascos_pasteurizados, fecha_pasteurizacion, responsable_pasteurizacion, usuario, volumen_total, fecha_hora_reg, id_user_reg, id_responsable_pasteurizacion, id_banco_de_leche) FROM stdin;
\.
...
COPY blh_receptor (id, id_banco_de_leche, id_paciente, codigo_receptor, fecha_registro_blh, procedencia, estado_receptor, edad_dias, peso_receptor, duracion_cpap, clasificacion_lubchengo, diagnostico_ingreso, duracion_npt, apgar_primer_minuto, edad_gest_fur, duracion_ventilacion, edad_gest_ballard, pc, talla_ingreso, apgar_quinto_minuto, usuario, fecha_hora_reg, id_user_reg, id_expediente) FROM stdin;
\.
...
COPY blh_solicitud (id, id_grupo_solicitud, codigo_solicitud, volumen_por_dia, acidez_necesaria, calorias_necesarias, peso_dia, volumen_por_toma, toma_por_dia, fecha_solicitud, cuna, estado, responsable, usuario, id_receptor, fecha_hora_reg, id_user_reg, id_responsable_solicitud, id_acidez_necesaria, id_calorias_necesarias, id_banco_de_leche) FROM stdin;
\.
...
SELECT pg_catalog.setval('ctl_documento_identidad_id_seq', 10, true);
...
--
-- Name: idx_codigo_acidez_dornic; Type: CONSTRAINT; Schema: public; Owner: siblh; Tablespace: 
--

ALTER TABLE ONLY blh_ctl_acidez_dornic
    ADD CONSTRAINT idx_codigo_acidez_dornic UNIQUE (codigo);


--
-- Name: idx_codigo_caloria; Type: CONSTRAINT; Schema: public; Owner: siblh; Tablespace: 
--

ALTER TABLE ONLY blh_ctl_caloria
    ADD CONSTRAINT idx_codigo_caloria UNIQUE (codigo);
...
--
-- Name: pk_blh_ctl_acidez_dornic; Type: CONSTRAINT; Schema: public; Owner: siblh; Tablespace: 
--

ALTER TABLE ONLY blh_ctl_acidez_dornic
    ADD CONSTRAINT pk_blh_ctl_acidez_dornic PRIMARY KEY (id);


--
-- Name: pk_blh_ctl_caloria; Type: CONSTRAINT; Schema: public; Owner: siblh; Tablespace: 
--

ALTER TABLE ONLY blh_ctl_caloria
    ADD CONSTRAINT pk_blh_ctl_caloria PRIMARY KEY (id);
...
--
-- Name: fk_acidez_necesaria_solicitud; Type: FK CONSTRAINT; Schema: public; Owner: siblh
--

ALTER TABLE ONLY blh_solicitud
    ADD CONSTRAINT fk_acidez_necesaria_solicitud FOREIGN KEY (id_acidez_necesaria) REFERENCES blh_ctl_acidez_dornic(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
--
-- Name: fk_banco_de_leche_pasteurizacion; Type: FK CONSTRAINT; Schema: public; Owner: siblh
--

ALTER TABLE ONLY blh_pasteurizacion
    ADD CONSTRAINT fk_banco_de_leche_pasteurizacion FOREIGN KEY (id_banco_de_leche) REFERENCES blh_banco_de_leche(id) ON UPDATE RESTRICT ON DELETE RESTRICT;


--
-- Name: fk_banco_de_leche_solicitud; Type: FK CONSTRAINT; Schema: public; Owner: siblh
--

ALTER TABLE ONLY blh_solicitud
    ADD CONSTRAINT fk_banco_de_leche_solicitud FOREIGN KEY (id_banco_de_leche) REFERENCES blh_banco_de_leche(id) ON UPDATE RESTRICT ON DELETE RESTRICT;


--
-- Name: fk_banco_de_leche_user_user; Type: FK CONSTRAINT; Schema: public; Owner: siblh
--

ALTER TABLE ONLY fos_user_user
    ADD CONSTRAINT fk_banco_de_leche_user_user FOREIGN KEY (id_banco_de_leche) REFERENCES blh_banco_de_leche(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
--
-- Name: fk_banco_leche_historia_actual; Type: FK CONSTRAINT; Schema: public; Owner: siblh
--

ALTER TABLE ONLY blh_historia_actual
    ADD CONSTRAINT fk_banco_leche_historia_actual FOREIGN KEY (id_banco_de_leche) REFERENCES blh_banco_de_leche(id) ON UPDATE RESTRICT ON DELETE RESTRICT;


--
-- Name: fk_banco_leche_historial_clinico; Type: FK CONSTRAINT; Schema: public; Owner: siblh
--

ALTER TABLE ONLY blh_historial_clinico
    ADD CONSTRAINT fk_banco_leche_historial_clinico FOREIGN KEY (id_banco_de_leche) REFERENCES blh_banco_de_leche(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
--
-- Name: fk_calorias_necesarias_solicitud; Type: FK CONSTRAINT; Schema: public; Owner: siblh
--

ALTER TABLE ONLY blh_solicitud
    ADD CONSTRAINT fk_calorias_necesarias_solicitud FOREIGN KEY (id_calorias_necesarias) REFERENCES blh_ctl_caloria(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
--
-- Name: fk_centro_recoleccion_donante; Type: FK CONSTRAINT; Schema: public; Owner: siblh
--

ALTER TABLE ONLY blh_donante
    ADD CONSTRAINT fk_centro_recoleccion_donante FOREIGN KEY (id_centro_recoleccion) REFERENCES blh_ctl_centro_recoleccion(id) ON UPDATE RESTRICT ON DELETE RESTRICT;


--
-- Name: fk_centro_recoleccion_historia_actual; Type: FK CONSTRAINT; Schema: public; Owner: siblh
--

ALTER TABLE ONLY blh_historia_actual
    ADD CONSTRAINT fk_centro_recoleccion_historia_actual FOREIGN KEY (id_centro_recoleccion) REFERENCES blh_ctl_centro_recoleccion(id) ON UPDATE RESTRICT ON DELETE RESTRICT;


--
-- Name: fk_centro_recoleccion_historial_clinico; Type: FK CONSTRAINT; Schema: public; Owner: siblh
--

ALTER TABLE ONLY blh_historial_clinico
    ADD CONSTRAINT fk_centro_recoleccion_historial_clinico FOREIGN KEY (id_centro_recoleccion) REFERENCES blh_ctl_centro_recoleccion(id) ON UPDATE RESTRICT ON DELETE RESTRICT;


--
-- Name: fk_centro_recoleccion_user_user; Type: FK CONSTRAINT; Schema: public; Owner: siblh
--

ALTER TABLE ONLY fos_user_user
    ADD CONSTRAINT fk_centro_recoleccion_user_user FOREIGN KEY (id_centro_recoleccion) REFERENCES blh_ctl_centro_recoleccion(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
--
-- Name: fk_expediente_donante; Type: FK CONSTRAINT; Schema: public; Owner: siblh
--

ALTER TABLE ONLY blh_donante
    ADD CONSTRAINT fk_expediente_donante FOREIGN KEY (id_expediente) REFERENCES mnt_expediente(id) ON UPDATE RESTRICT ON DELETE RESTRICT;


--
-- Name: fk_expediente_receptor; Type: FK CONSTRAINT; Schema: public; Owner: siblh
--

ALTER TABLE ONLY blh_receptor
    ADD CONSTRAINT fk_expediente_receptor FOREIGN KEY (id_expediente) REFERENCES mnt_expediente(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
--
-- Name: fk_patologia_embarazo_historial_clinico; Type: FK CONSTRAINT; Schema: public; Owner: siblh
--

ALTER TABLE ONLY blh_historial_clinico
    ADD CONSTRAINT fk_patologia_embarazo_historial_clinico FOREIGN KEY (id_patologia_embarazo) REFERENCES ctl_patologia(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
--
-- Name: fk_responsable_solicitud; Type: FK CONSTRAINT; Schema: public; Owner: siblh
--

ALTER TABLE ONLY blh_solicitud
    ADD CONSTRAINT fk_responsable_solicitud FOREIGN KEY (id_responsable_solicitud) REFERENCES mnt_empleado(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
