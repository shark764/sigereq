...
--
-- Name: ctl_canton; Type: TABLE; Schema: public; Owner: siap; Tablespace: 
--
...
ALTER TABLE ctl_canton OWNER TO siap;

--
-- Name: TABLE ctl_canton; Type: COMMENT; Schema: public; Owner: siap
--
...
--
-- Name: COLUMN ctl_canton.id; Type: COMMENT; Schema: public; Owner: siap
--
...
--
-- Name: COLUMN ctl_canton.nombre; Type: COMMENT; Schema: public; Owner: siap
--
...
--
-- Name: COLUMN ctl_canton.codigo_digestyc; Type: COMMENT; Schema: public; Owner: siap
--
...
--
-- Name: COLUMN ctl_canton.id_municipio; Type: COMMENT; Schema: public; Owner: siap
--
...
--
-- Name: ctl_canton_id_seq; Type: SEQUENCE; Schema: public; Owner: siap
--
...
ALTER TABLE ctl_canton_id_seq OWNER TO siap;

--
-- Name: ctl_canton_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: siap
--
...
--
-- Name: id; Type: DEFAULT; Schema: public; Owner: siap
--
...
COPY blh_ctl_centro_recoleccion (id, nombre, telefono, fecha_hora_reg, id_user_reg) FROM stdin;
\.
...
SELECT pg_catalog.setval('blh_curva_id_seq', 1, false);
...
--
-- Data for Name: ctl_canton; Type: TABLE DATA; Schema: public; Owner: siap
--
...
--
-- Name: ctl_canton_id_seq; Type: SEQUENCE SET; Schema: public; Owner: siap
--
...
SELECT pg_catalog.setval('ctl_ocupacion_id_seq', 1, false);
...
--
-- Name: pk_ctl_canton; Type: CONSTRAINT; Schema: public; Owner: siap; Tablespace: 
--
...
--
-- Name: fk_municipio_canton; Type: FK CONSTRAINT; Schema: public; Owner: siap
--
