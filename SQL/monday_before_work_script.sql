...
COPY blh_historia_actual (id, peso_donante, talla_donante, medicamento, habito_toxico, motivo_donacion, patologia, imc, estado_donante, usuario, id_donante, fecha_hora_reg, id_user_reg, donante_apta) FROM stdin;
\.
...
COPY blh_historial_clinico (id, control_prenatal, edad_gest_fur, lugar_control, numero_control, fecha_parto, lugar_parto, patologia_embarazo, periodo_intergenesico, fecha_parto_anterior, formula_obstetrica_g, formula_obstetrica_p1, formula_obstetrica_p2, formula_obstetrica_a, formula_obstetrica_v, formula_obstetrica_m, usuario, id_donante, id_establecimiento, fecha_hora_reg, id_user_reg, control_prenatal_embarazo, id_patologia_embarazo) FROM stdin;
\.
